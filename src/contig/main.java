...
//                int end_con = input.nextInt();
               ...
               obj.y= f.addfolder(splited[1], FOLDER);
            }
...
//                
                String[] splited2 = splited[1].split("/") ;
                FolderLinked FOLDER = new FolderLinked(splited2[splited2.length-1],arr_linked,0) ;
                obj.y=fl.addfolder(splited[1], FOLDER);
            }
...
//                
                String[] splited2 = splited[1].split("/") ;
                FolderIndex FOLDER = new FolderIndex(splited2[splited2.length-1],arr_indexed,0) ;
                obj.y=f2.addfolder(splited[1], FOLDER);
            }
...
//                int end = input.nextInt();
                String[] splited2 = splited[1].split("/") ;
                FilesInterface Addfile = new FilesInterface(splited2[splited2.length-1],start_con,end_con,0) ;
                
               obj.y= f.addfile(splited[1], Addfile);
            }
                ...
                String[] splited2 = splited[1].split("/") ;
                FilesInterfaceLinker Addfile = new FilesInterfaceLinker(splited2[splited2.length-1],arr_linked,0) ;
                
                obj.y=fl.addfile(splited[1], Addfile);
            }
...
//                
                String[] splited2 = splited[1].split("/") ;
                FilesInterfaceLinker Addfile = new FilesInterfaceLinker(splited2[splited2.length-1],arr_indexed,0) ;
                
               obj.y= f2.addfile(splited[1], Addfile);
            }  
            ...
            //delete file
               ...
               obj.y= f.DeleteFile(splited[1]);
            }
            else if(splited[0].equals("DeleteFile")&&check==2){
               obj.y= fl.DeleteFile(splited[1]);
            }
            else if(splited[0].equals("DeleteFile")&&check==3){
               obj.y= f2.DeleteFile(splited[1]);
            }
            ...
            {
                obj.y=f.DeleteFolder(splited[1]) ;
            }
              else if(splited[0].equals("DeleteFolder")&&check==2)
            {
                obj.y=fl.DeleteFolder(splited[1]+"/fake") ;
            }
               else if(splited[0].equals("DeleteFolder")&&check==3)
            {
                obj.y=f2.DeleteFolder(splited[1]+"/fake") ;
            }
